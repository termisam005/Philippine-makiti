            ...
            <Content>
                <div className="wrap_tabline">
                    <div className="tabline">
                        ...
                        <MenuTab tabClass={'btn_tab on'} title={'Code Information'} />
                    </div>
                    ...
                    <div className="with_colline">
                        <article className="m-b-12">
                            <ul className="depth_line">
                                ...
                                <li className="depth">Code Information</li>
                            </ul>
                            <div className="big_title_line gap_12">
                                <h1 className="big_title">Code Information</h1>
                                ...
                                <div className="dflx_ac_jbet gap_40">
                                    <div className="grid_column3 gap_40 w-85">
                                        <div className="dflx_ac gap_20">
                                            <p className="forms_word">Usage Status</p>
                                        ...
                                        <div className="dflx_ac gap_20">
                                            <p className="forms_word">Code Name/ID</p>
                                            <Input type={"text"} placeholder={"Code Name/ID"} className={"wrput line medium flex1 tac w300"}/>
                                        </div>
                                    </div>
