                ...
                <div className="with_colline">
                    <article className="m-b-12">
                        <ul className="depth_line">
                            ...
                            <li className="depth">Fare Information</li>
                        </ul>
                        <div className="big_title_line gap_12">
                            <h1 className="big_title">Fare Information</h1>
                    ...
                    <div className={contentTab === 1? "dflx_column flex1" : "dflx_column flex1 hide"}>
                        ...
                        <section className="infomation_line">
                            <div className="information_box">
                                <div>
                                    <h5 className='edit_tlt lh_20 m-b-20'>Fare Information Edit</h5>
                                </div>
                                <div className="infomation_form">
                                    <div className='info_form left'>
                                        <dl className="check_dl info">
                                            <dt>Basic Fare
                                                <br/>
                                                (PHP)
                                            </dt>
                            ...
                            <div className="cardholder_box">
                                <div>
                                    <h5 className='edit_tlt lh_20 m-b-20'>Fare for each cardholder(PHP)</h5>
                                </div>
                            ...
                            <div className="cardholder_box">
                                <div>
                                    <h5 className='edit_tlt lh_20 m-b-20'>Discount for each cardholder(%)</h5>
                                </div>
                                <div className='info_form'>
                                    <dl className="check_dl info">
                                        <dt>Regular</dt>
